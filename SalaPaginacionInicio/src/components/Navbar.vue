<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <router-link class="navbar-brand" to="/">Sala Gurugú</router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
          <router-link class="nav-link active" aria-current="page" to="/">Programación</router-link>
          </li>
          <li>
          <router-link class="nav-link active" aria-current="page" to="/sala">Sala</router-link>
          </li>
            <li class="nav-item">
          <router-link class="nav-link active" aria-current="page" to="/lista-obras">Lista</router-link>
          </li>
          <li class="nav-item">
           <router-link v-if="existeUsuario" class="nav-link active" aria-current="page" to="/formulario">Formulario</router-link>
          </li>
        </ul>
        <form class="d-flex">
